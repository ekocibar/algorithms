...
A, lying on the floor in a line. For each I (0 ≤ I < N), the length of rope I
on the line is A[I].
...
We can tie:
    ...
    - rope 4 with rope 5 with rope 6 to produce a rope of length
    A[4] + A[5] + A[6] = 5.
...
max number of ropes of length greater than or equal to K that can be created.
